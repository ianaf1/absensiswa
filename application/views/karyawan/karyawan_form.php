            ...
            <div class='box box-<?= $box; ?>'>
                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="jabatan" class="control-label">Tingkat<?php echo form_error('jabatan') ?></label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="gedung_id" class="control-label">Rombel<?php echo form_error('gedung') ?></label>
                            <div class="input-group">
