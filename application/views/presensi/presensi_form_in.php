                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="id_karyawan" class="control-label">Nama Siswa</label>
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Nama Siswa harus diisi" name="id_karyawan" id="id_karyawan" placeholder="nama karyawan" required />
